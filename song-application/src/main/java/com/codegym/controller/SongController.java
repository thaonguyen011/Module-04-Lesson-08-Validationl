...
public class SongController {
    ...
    @PostMapping("/add")
    public String add(@Valid @ModelAttribute("songForm") SongForm songForm, BindingResult bindingResult, RedirectAttributes redirect) {
    ...
    @PostMapping("/update")
    public String update(@Valid @ModelAttribute("songForm") SongForm songForm, BindingResult bindingResult, RedirectAttributes redirect) {
        if (bindingResult.hasFieldErrors()) {
            return "/update";
        }
        MultipartFile multipartFile = songForm.getFileURL();
